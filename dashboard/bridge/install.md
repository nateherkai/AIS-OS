...
Bryan runs a local AIOS dashboard at `http://127.0.0.1:8080` (FastAPI). It
...
```bash
curl -s -X POST http://127.0.0.1:8080/api/bridge/query \
...
**Handshake (no auth required):** `GET http://127.0.0.1:8080/api/bridge/handshake`
